...
from langchain.prompts.few_shot_with_templates import LengthBasedExampleSelector
from dotenv import load_dotenv

load_dotenv()

def getLLMResponse(quer,age_options, task_type_options):
    # Set the OpenAI API key
    llm = OpenAI(model="gpt-3.5-turbo-instruct", temperature=.9)
    if age_options == "kid":
        if age_options=="Kid": #Silly and Sweet Kid 
    ...
    elif age_options=="Adult":  #Curious and Intelligent adult 
        examples = [
        {
            "query": "What is a mobile?",
    ...
    elif age_options=="Senior Citizen": #A 90 years old guys
        examples = [
        {
            "query": "What is a mobile?",
